...
function ReviewsPanel() {
  return (
    <div>
      <article className="bg-white md:hover:bg-slate-50 md:p-6 shadow-md md:shadow-none px-4 py-3 rounded-lg">
        ...
        <div className="flex items-center mb-2 gap-x-2 rtl:space-x-reverse">
          <h3 className="md:text-sm text-lg font-semibold text-gray-900 dark:text-white">
